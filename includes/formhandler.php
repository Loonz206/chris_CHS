<?php
//This is a very simple PHP script that outputs the name of each bit of information in the browser window, and then sends it all to an email address you add to the script. The original code came from Elizabeth Castro.
...
$body ="Here is the message from your web site:\n";
...
$from='From: '. $email . "(" . $first_name . $last_name . ")" . "\r\n"; 
...
mail ('hsanton@live.com', $subject, $body, $from);

header('Location: ../thanks.php'); // replace "thx.html" with the name and path from the form handler to your thank you page